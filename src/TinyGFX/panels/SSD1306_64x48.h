// TinyGFXPanelSSD1306_64x48
//
// The 0.66 inch module.
//
...
class TinyGFXPanelSSD1306_64x48 : public TinyGFXDriverSSD1306 {
 public:
  static const int16_t kWidth = 64;
  static const int16_t kHeight = 48;
  /// Size the framebuffer with this, so it cannot be got wrong:
  ///   static uint8_t fb[TinyGFXPanelSSD1306_64x48::kBufferBytes];
  ...
  TinyGFXPanelSSD1306_64x48(TinyGFXBus& bus, uint8_t* buffer, int16_t bufferPages = 0)
...
#define TINYGFX_PANEL TinyGFXPanelSSD1306_64x48
#endif
