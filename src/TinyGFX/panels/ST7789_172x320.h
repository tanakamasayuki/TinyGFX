// TinyGFXPanelST7789_172x320
//
// The 1.47 inch bar, centred across its memory.
//
...
class TinyGFXPanelST7789_172x320 : public TinyGFXDriverST7789 {
 public:
  static const int16_t kWidth = 172;
  static const int16_t kHeight = 320;

  explicit TinyGFXPanelST7789_172x320(TinyGFXBus& bus, int8_t rst = -1)
...
#define TINYGFX_PANEL TinyGFXPanelST7789_172x320
#endif
