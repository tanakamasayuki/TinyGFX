...
| 区分 | 言語 | 対象 |
| --- | --- | --- |
| 使う人が読むもの | 日英 | `../README.ja.md`、`GUIDE.ja.md`、[API.ja.md](API.ja.md)、[GLOSSARY.ja.md](GLOSSARY.ja.md)、[PANEL_TUNING.ja.md](PANEL_TUNING.ja.md)、`../examples/README.ja.md`、`../tests/README.ja.md` |
...
| **パネルの絵がずれる・出ない。どこを変えるか知る** | **[PANEL_TUNING.ja.md](PANEL_TUNING.ja.md)** |
